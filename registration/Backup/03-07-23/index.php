                                ...
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        <form>
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Your Address *" value="" required/>
                                            </div>
                                            <div class="form-group">
                                                <input type="text" class="date form-control" placeholder="Select Date of Birth*" required/>
                                            ...
                                            <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Enter Your Area*" required/>
                                            </div>                                        
                                            <div class="form-group">
                                            ...
                                            <input type="radio" id="left_hand_rd" name="bastman_type" class="" value="LHBT" required/>&nbsp;<label>Left Hand</label>&nbsp;
                                            <input type="radio" id="right_hand_rd" name="bastman_type" class="" value="RHBT" required/>&nbsp;<label>Right Hand</label><br/>
                                            </div>
                                            <div class="form-group" id="bowler_type_div" style="display:none">
                                            <input type="radio" name="bowler_type" id="bowler_faster" value="Faster" required/>&nbsp;<label>Faster</label>&nbsp;
                                                <input type="radio" name="bowler_type" id="bowler_medium_faster" value="MediumFaster" required/>&nbsp;<label>Medium Faster</label>&nbsp;
                                                <input type="radio" name="bowler_type" id="bowler_spinner" value="Spinner" required/>&nbsp;<label>Spinner</label>&nbsp;
                                            </div>
                                            <div class="form-group" id="spin_type_div" style="display:none">
                                                <input type="radio" name="spin_type" id="spin_off" value="OffSpin" required/>&nbsp;<label>Off Spin</label>&nbsp;
                                                <input type="radio" name="spin_type" id="spin_leg" value="LegSpin" required/>&nbsp;<label>Leg Spin</label>&nbsp;
                                                <input type="radio" name="spin_type" id="spin_left_arm" value="LeftArmSpin" required/>&nbsp;<label>Left Arm Spinner</label>&nbsp;
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" minlength="10" maxlength="10" name="txtEmpPhone" class="form-control" placeholder="Mobile Number *" value="" required/>
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" class="form-control"  placeholder="Your City *" value="" required/>
                                                </div>
                                                <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Enter MCA Card Number*" required/>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group" >
                                                    ...
                                                    <input type="text" style="display:none" class="form-control" name="division_name" id="division_name" placeholder="Enter Divison Name*" required/>
                                                </div>
