                                ...
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        <form name="register_form" id="register_form" action="ajax.php" method="POST" enctype="multipart/form-data" >
                                            ...
                                            <div class="form-group">
                                                <select name="player_type_select" id="player_type_select" class="form-control"  required >
...
​
            ...
            <script>
                $(document).ready(function(){
                    ...
                    // var CheckPlayedTeam=$("#lastYearPlayed").is(":checked");
                    // var isplayed=CheckPlayedTeam ? 'Y':'N';
                    // bl.click(function(){
                    //     var value=$("#lastYearPlayed").is(":checked");
                    //     value == true ? alert('yes') : alert('no');
                    // });
                    ...
                    bl.click(function(e)
                    {
                        ...
                        if(firstname=='' || !isNaN(firstname) || lastname=='' || !isNaN(lastname) || (player_type_select=='' && spinner_type_select=='') )
                        {
                            Swal.fire({
                            icon: 'error',
                            title: 'Oops...',
                            ...
                            return false;
                                ...
                                error: function(xhr, status, error){
                                    ...
                                    if(xhr.status==400){
                                        ...
                                        swal("Error","Failed to Insert Data: "+error,"error");
                                    }
                                }
                            });
                        }
